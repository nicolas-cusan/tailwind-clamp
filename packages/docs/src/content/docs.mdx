...
description: A Tailwind CSS plugin to use CSS clamp in your projects
---
import Conditional  from '../components/Conditional.astro';
import BtnList from '../components/BtnList.astro';
...
<Conditional target="astro">
<ResizeDemo label="Resize to see fluid padding and typography in action">
  <div class="clamp-[p,0.75rem,2.5rem,17.5rem,50rem]">
    <p class="clamp-[text,1.125rem,2.25rem,17.5rem,50rem] font-bold clamp-[mb,0.25rem,0.75rem,17.5rem,50rem]">Fluid heading</p>
    <p class="clamp-[text,0.8125rem,1.0625rem,17.5rem,50rem] text-stone-500 leading-relaxed mb-0">This text and the surrounding padding scale fluidly with the viewport width using <code>clamp()</code>.</p>
  </div>
</ResizeDemo>
</Conditional>
...
<Conditional target="astro">
<ResizeDemo label="Custom property storing a clamp value, reused via var()" height="150px">
  <div class="clamp-[--demo-space,0.25rem,2rem,17.5rem,50rem] clamp-[p,0.75rem,2rem,17.5rem,50rem]">
    <div class="flex gap-[var(--demo-space)]">
      <div class="bg-stone-300 rounded clamp-[size,2.5rem,5rem,17.5rem,50rem] flex-none"></div>
      <div class="bg-stone-300 rounded clamp-[size,2.5rem,5rem,17.5rem,50rem] flex-none"></div>
      <div class="bg-stone-300 rounded clamp-[size,2.5rem,5rem,17.5rem,50rem] flex-none"></div>
    </div>
    <p class="text-sm text-stone-500 mb-0 mt-3">Gap and box size scale via <code>clamp()</code> stored in a CSS variable</p>
  </div>
</ResizeDemo>
</Conditional>
